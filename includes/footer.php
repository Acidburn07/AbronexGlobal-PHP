<footer class="bg-[#1B4484] pt-16 pb-8 mt-auto font-secondary text-white">
      ...
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <img src="/projectabronex/assets/Abronex_Global_Logo.png" alt="Abronex Global Logo" class="brightness-0 invert w-auto h-10 mb-4">
            ...
            <div class="flex gap-4 mt-6">
              <a href="#" class="text-gray-300 hover:text-white transition text-xl" aria-label="LinkedIn">
                <i class="fa-brands fa-linkedin"></i>
              </a>
              
              <a href="#" class="text-gray-300 hover:text-white transition text-xl" aria-label="Facebook">
                <i class="fa-brands fa-facebook"></i>
              </a>
              
              <a href="#" class="text-gray-300 hover:text-white transition text-xl" aria-label="X (Twitter)">
                <i class="fa-brands fa-x-twitter"></i>
              </a>
              
              <a href="#" class="text-gray-300 hover:text-white transition text-xl" aria-label="Instagram">
          ...
          <div>
            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start gap-4">
                <div class="mt-1 flex-shrink-0 text-brand">
