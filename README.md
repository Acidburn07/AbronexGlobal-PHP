...
In this section, list and describe the features or functionality that you are working on. You can use checkboxes to track the progress of each feature.
 ...
 -allows collect student details like name, academics, and test scores.
 -helps to understand what kind of counseling the student needs.
 -students can identify preferred country easily.
 -To ensure students agree to terms and privacy rules.
...
Table 1 (Tanka RAj Aryal): student_application
I have created table in myphpadmin as student_application.
...
Form 1 (Tanka Raj Aryal): Free Consultation:
My form includes Fullname, Query, Academic Profile, Language Test, preferred Country, Nearest Branch and Consent.
Shell link:http://shell.hamk.fi/~amk1010360/AbronexGlobal-PHP/Application/application.php
